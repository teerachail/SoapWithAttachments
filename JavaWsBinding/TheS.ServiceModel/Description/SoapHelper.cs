...
//----------------------------------------------------------------------------
namespace TheS.ServiceModel.Description
{
    using System;
    ...
    static class SoapHelper
    {
        ...
        static class SoapConverter
        {
            ...
            static WsdlNS.SoapBodyBinding ConvertSoapBodyBinding(WsdlNS.SoapBodyBinding src, EnvelopeVersion version)
            {
                ...
                if (src != null)
                {
                    if (MyJavaHelper.GetEncoding(srcVersion) == src.Encoding)
                        dest.Encoding = MyJavaHelper.GetEncoding(version);
                    dest.Encoding = MyJavaHelper.GetEncoding(version);
        ...
        static WsdlNS.SoapAddressBinding CreateSoapAddressBinding(EnvelopeVersion version, WsdlNS.Port wsdlPort)
        {
            ...
            Debug.Assert(soapAddressBinding != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
        ...
        static WsdlNS.SoapBinding CreateSoapBinding(EnvelopeVersion version, WsdlNS.Binding wsdlBinding)
        {
            ...
            Debug.Assert(soapBinding != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
        ...
        static WsdlNS.SoapOperationBinding CreateSoapOperationBinding(EnvelopeVersion version, WsdlNS.OperationBinding wsdlOperationBinding)
        {
            ...
            Debug.Assert(soapOperationBinding != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
        ...
        static WsdlNS.SoapBodyBinding CreateSoapBodyBinding(EnvelopeVersion version, WsdlNS.MessageBinding wsdlMessageBinding)
        {
            ...
            Debug.Assert(soapBodyBinding != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
        ...
        static WsdlNS.SoapHeaderBinding CreateSoapHeaderBinding(EnvelopeVersion version, WsdlNS.MessageBinding wsdlMessageBinding)
        {
            ...
            Debug.Assert(soapHeaderBinding != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
        ...
        static XmlElement CreateSoapFaultBinding(EnvelopeVersion version)
        {
            ...
            Debug.Assert(ns != null, "EnvelopeVersion is not recognized. Please update the SoapHelper class");
            ...
            internal static string GetEncoding(EnvelopeVersion version)
            {
                ...
                else
                {
                    throw new ArgumentException("version",
                        string.Format("SR.EnvelopeVersionNotSupported, {0}", version));
                }
            }
        }
    }
