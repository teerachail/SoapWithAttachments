    ...
    class MessageVersionConverter : TypeConverter
    {
                ...
                switch (messageVersion)
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException("value",
                            string.Format("SR.ConfigInvalidClassFactoryValue, {0}, {1}", messageVersion, typeof(MessageVersion).FullName));
                }
                return retval;
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            if (typeof(string) == destinationType && value is MessageVersion)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value",
                        string.Format("SR.ConfigInvalidClassInstanceValue, {0}", typeof(MessageVersion).FullName));
                }
                return retval;
            }
