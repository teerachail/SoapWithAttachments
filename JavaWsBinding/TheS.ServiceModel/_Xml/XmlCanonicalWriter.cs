...
namespace TheS.Xml
{
    ...
    sealed class XmlCanonicalWriter
    {
        ...
        public void WriteStartElement(byte[] prefixBuffer, int prefixOffset, int prefixLength, byte[] localNameBuffer, int localNameOffset, int localNameLength)
        {
            ...
            if (prefixOffset < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("prefixOffset", "SR.ValueMustBeNonNegative"));
            if (prefixOffset > prefixBuffer.Length)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("prefixOffset", string.Format("SR.OffsetExceedsBufferSize, {0}", prefixBuffer.Length)));
            if (prefixLength < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("prefixLength", "SR.ValueMustBeNonNegative"));
            if (prefixLength > prefixBuffer.Length - prefixOffset)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("prefixLength", string.Format("SR.SizeExceedsRemainingBufferSpace, {0}", prefixBuffer.Length - prefixOffset)));
            ...
            if (localNameOffset < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("localNameOffset", "SR.ValueMustBeNonNegative"));
            if (localNameOffset > localNameBuffer.Length)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("localNameOffset", string.Format("SR.OffsetExceedsBufferSize, {0}", localNameBuffer.Length)));
            if (localNameLength < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("localNameLength", "SR.ValueMustBeNonNegative"));
            if (localNameLength > localNameBuffer.Length - localNameOffset)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("localNameLength", string.Format("SR.SizeExceedsRemainingBufferSpace, {0}", localNameBuffer.Length - localNameOffset)));
            ThrowIfClosed();
            bool isRootElement = (this.depth == 0);
        ...
        public void WriteXmlnsAttribute(string prefix, string ns)
        {
            ...
            if (prefix.Length > int.MaxValue - ns.Length)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("ns", string.Format("SR.CombinedPrefixNSLength, {0}", int.MaxValue / maxBytesPerChar)));
        ...
        public void WriteXmlnsAttribute(byte[] prefixBuffer, int prefixOffset, int prefixLength, byte[] nsBuffer, int nsOffset, int nsLength)
        {
            ...
            if (nsOffset < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nsOffset", "SR.ValueMustBeNonNegative"));
            if (nsOffset > nsBuffer.Length)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nsOffset", string.Format("SR.OffsetExceedsBufferSize, {0}", nsBuffer.Length)));
            if (nsLength < 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nsLength", "SR.ValueMustBeNonNegative"));
            if (nsLength > nsBuffer.Length - nsOffset)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nsLength", string.Format("SR.SizeExceedsRemainingBufferSpace, {0}", nsBuffer.Length - nsOffset)));
            ThrowIfClosed();
            if (prefixLength > int.MaxValue - nsLength)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nsLength", string.Format("SR.CombinedPrefixNSLength, {0}", int.MaxValue)));
