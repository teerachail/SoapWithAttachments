...
namespace TheS.Xml
{
    ...
    abstract class XmlStreamNodeWriter : XmlNodeWriter
    {
        ...
        AsyncCompletionResult FlushBufferAsync(AsyncEventArgs<object> state)
        {
            ...
            {
                throw FxTrace.Exception.AsError(new InvalidOperationException("SR.FlushBufferAlreadyInUse"));
            }
            ...
            {
                throw FxTrace.Exception.AsError(new InvalidOperationException("SR.NoAsyncWritePending"));
            }
