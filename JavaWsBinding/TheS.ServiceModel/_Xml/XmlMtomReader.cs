...
#pragma warning suppress 56503 // [....], required by the XmlReader
                get { throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.SeekNotSupportedOnStream, {0}", this.GetType().FullName))); }
            }
            ...
            public override long Position
            {
                ...
                {
#pragma warning suppress 56503 // [....], required by the XmlReader
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.SeekNotSupportedOnStream, {0}", this.GetType().FullName)));
                }
                set { throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.SeekNotSupportedOnStream, {0}", this.GetType().FullName))); }
            }

            public override IAsyncResult BeginWrite(byte[] buffer, int offset, int count, AsyncCallback callback, object state)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.WriteNotSupportedOnStream, {0}", this.GetType().FullName)));
            }
    ...
    internal class MimeHeaders
    {
        ...
        public void Add(MimeHeader header)
        {
            ...
            if (headers.TryGetValue(header.Name, out existingHeader))
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(string.Format("SR.MimeReaderHeaderAlreadyExists, {0}", header.Name)));
            else
                            ...
                            for (; ptr < end; ptr++)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (*ptr < 33 || *ptr > 126)
                                    {
                                        ...
                                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(string.Format("SR.MimeHeaderInvalidCharacter, {0}, {1}", (char)(*ptr), ((int)(*ptr)).ToString("X", CultureInfo.InvariantCulture))));
                                    }
                                }
                            }
                            AppendName(new string((sbyte*)start, 0, (int)(ptr - start)), maxBuffer, ref remaining);
...
#pragma warning suppress 56503 // [....], required by the Stream contract
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.SeekNotSupportedOnStream, {0}", stream.GetType().FullName)));
            }
        }
...
#pragma warning suppress 56503 // [....], required by the Stream contract
        ...
        {
            if (!CanRead)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.ReadNotSupportedOnStream, {0}", stream.GetType().FullName)));
        ...
        public override IAsyncResult BeginWrite(byte[] buffer, int offset, int count, AsyncCallback callback, object state)
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.WriteNotSupportedOnStream, {0}", stream.GetType().FullName)));
        }
    ...
    internal static class MailBnfHelper
    {
        ...
        public static bool SkipCFWS(string data, ref int offset)
        {
            ...
            {
                if (data[offset] > 127)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(string.Format("SR.MimeHeaderInvalidCharacter, {0}, {1}", data[offset], ((int)data[offset]).ToString("X", CultureInfo.InvariantCulture))));
