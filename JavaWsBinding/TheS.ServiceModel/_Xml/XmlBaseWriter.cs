    ...
    abstract class XmlBaseWriter : XmlDictionaryWriter, IFragmentCapableXmlDictionaryWriter
    {
        ...
        public override void WriteXmlnsAttribute(string prefix, string ns)
        {
            ...
            if (writeState != WriteState.Element)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteXmlnsAttribute", WriteState.ToString())));
        ...
        void StartAttribute(ref string prefix, string localName, string ns, XmlDictionaryString xNs)
        {
            ...
            if (writeState != WriteState.Element)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteStartAttribute", WriteState.ToString())));
            ...
            if (prefix == "xml")
            {
                if (ns != null && ns != xmlNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlPrefixBoundToNamespace, {0}, {1}, {2}", "xml", xmlNamespace, ns), "ns"));
                isXmlAttribute = true;
            ...
            else if (prefix == "xmlns")
            {
                if (ns != null && ns != xmlnsNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlPrefixBoundToNamespace, {0}, {1}, {2}", "xmlns", xmlnsNamespace, ns), "ns"));
            ...
            else if (ns == null)
            {
                ...
                else
                {
                    ...
                    if (ns == null)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlUndefinedPrefix, {0}", prefix), "prefix"));
                }
            }
            else if (ns.Length == 0)
            {
                ...
                if (prefix.Length != 0)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlEmptyNamespaceRequiresNullPrefix", "prefix"));
            }
            else if (prefix.Length == 0)
            {
                ...
                if (prefix == null)
                {
                    ...
                    if (ns.Length == xmlnsNamespace.Length && ns == xmlnsNamespace)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlSpecificBindingNamespace, {0}, {1}", "xmlns", ns)));
                    if (ns.Length == xmlNamespace.Length && ns == xmlNamespace)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlSpecificBindingNamespace, {0}, {1}", "xml", ns)));
        ...
        public override void WriteEndAttribute()
        {
            ...
            if (writeState != WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteEndAttribute", WriteState.ToString())));
            ...
            try
            {
                if (isXmlAttribute)
                {
                    ...
                    else if (attributeLocalName == "space")
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlInvalidXmlSpace, {0}", attributeValue)));
                        }
                    }
                    else
                    {
        ...
        public override void WriteComment(string text)
        {
            ...
            if (writeState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteComment", WriteState.ToString())));
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlInvalidCommentChars", "text"));
            }
        ...
        public override void WriteFullEndElement()
        {
            ...
            if (writeState != WriteState.Element && writeState != WriteState.Content)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteFullEndElement", WriteState.ToString())));
        ...
        public override void WriteCData(string text)
        {
            ...
            if (writeState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteCData", WriteState.ToString())));
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.XmlMethodNotSupported, {0}", "WriteDocType")));
        }
        ...
        void StartElement(ref string prefix, string localName, string ns, XmlDictionaryString xNs)
        {
            ...
            if (localName.Length == 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.InvalidLocalNameEmpty", "localName"));
            if (writeState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteStartElement", WriteState.ToString())));
        ...
        public override void WriteEndElement()
        {
            ...
            if (depth == 0)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidDepth, {0}, {1}", "WriteEndElement", depth.ToString(CultureInfo.InvariantCulture))));
        ...
        string GetQualifiedNamePrefix(string namespaceUri, XmlDictionaryString xNs)
        {
            ...
            {
                if (writeState != WriteState.Attribute)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlNamespaceNotFound, {0}", namespaceUri), "namespaceUri"));
        ...
        public override void WriteStartDocument()
        {
            ...
            if (writeState != WriteState.Start)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteStartDocument", WriteState.ToString())));
        ...
        public override void WriteProcessingInstruction(string name, string text)
        {
            ...
            if (name != "xml")
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlProcessingInstructionNotSupported", "name"));

            if (writeState != WriteState.Start)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException("SR.XmlInvalidDeclaration"));
        ...
        public override void WriteEndDocument()
        {
            ...
            if (writeState == WriteState.Start || writeState == WriteState.Prolog)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException("SR.XmlNoRootElement"));
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.XmlMethodNotSupported, {0}", "WriteEntityRef")));
        }
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(string.Format("SR.XmlMethodNotSupported, {0}", "WriteNmToken")));
        }
        ...
        public override void WriteWhitespace(string whitespace)
        {
            ...
            for (int i = 0; i < whitespace.Length; ++i)
            {
                ...
                if (c != ' ' &&
                    ...
                    c != '\n' &&
                    c != '\r')
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlOnlyWhitespace", "whitespace"));
            }
        ...
        public override void WriteCharEntity(char ch)
        {
            ...
            if (ch >= 0xd800 && ch <= 0xdfff)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlMissingLowSurrogate", "ch"));
        ...
        protected void WritePrimitiveValue(object value)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlNestedArraysNotSupported", "value"));
            }
            else
            {
        ...
        public void StartFragment(Stream stream, bool generateSelfContainedTextFragment)
        {
            ...
            if (WriteState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "StartFragment", WriteState.ToString())));
            FlushElement();
            writer.Flush();
        ...
        public void EndFragment()
        {
            ...
            if (oldStream == null && oldWriter == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException());
            if (WriteState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "EndFragment", WriteState.ToString())));
        ...
        public void WriteFragment(byte[] buffer, int offset, int count)
        {
            ...
            if (WriteState == WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidWriteState, {0}, {1}", "WriteFragment", WriteState.ToString())));
        ...
        string GeneratePrefix(string ns, XmlDictionaryString xNs)
        {
            if (writeState != WriteState.Element && writeState != WriteState.Attribute)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(string.Format("SR.XmlInvalidPrefixState, {0}", WriteState.ToString())));
        ...
        class NamespaceManager
        {
            ...
            public void AddNamespace(string prefix, string uri, XmlDictionaryString uriDictionaryString)
            {
                if (prefix.Length >= 3)
                {
                    ...
                    if ((prefix[0] & ~32) == 'X' && (prefix[1] & ~32) == 'M' && (prefix[2] & ~32) == 'L')
                    {
                        ...
                        if (prefix == "xmlns" && uri == xmlnsNamespace)
                            return;
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlReservedPrefix", "prefix"));
                    }
                }
                Namespace nameSpace;
                for (int i = nsCount - 1; i >= 0; i--)
                {
                    ...
                    if (nameSpace.Prefix == prefix)
                    {
                        if (nameSpace.Uri == uri)
                            return;
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlPrefixBoundToNamespace, {0}, {1}, {2}", prefix, nameSpace.Uri, uri), "prefix"));
                    }
                }
                if (prefix.Length != 0 && uri.Length == 0)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException("SR.XmlEmptyNamespaceRequiresNullPrefix", "prefix"));
                if (uri.Length == xmlnsNamespace.Length && uri == xmlnsNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlSpecificBindingNamespace, {0}, {1}", "xmlns", uri)));
                ...
                if (uri.Length == xmlNamespace.Length && uri[18] == 'X' && uri == xmlNamespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(string.Format("SR.XmlSpecificBindingNamespace, {0}, {1}", "xml", uri)));
